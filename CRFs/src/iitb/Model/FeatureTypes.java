 ...
 */
/* @notes by Chris Orescan
 *  total number of FeatureTypes are counted in FeatureGenImpl.
 *      Each FeatureType is represented with the current number of FeatureTypes in FeatureGenImpl (thisTypeId)
 *
 *
 */
