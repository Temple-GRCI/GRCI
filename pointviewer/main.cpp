...
int main(int argc, char ** argv)
{
	...
	// Initialize OpenNI
	rc = g_Context.InitFromXmlFile("KinConfig.xml", &errors);
	...
	g_pSessionManager->RegisterSession(NULL, SessionStarting, SessionEnding, FocusProgress);//sets session boolean to true/false

	g_pDrawer = new XnVPointDrawer(100, g_DepthGenerator);//takes in history and depth generator

        g_pFlowRouter = new XnVFlowRouter;
	g_pFlowRouter->SetActive(g_pDrawer);//feeds all data to the point drawer object
